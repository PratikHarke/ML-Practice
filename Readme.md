...
| Topic | Description |
|---|---|
| Single Variate Linear Regression | Predicting output from a single input feature |
| Multi Variate Linear Regression | Regression with multiple input features |
...
Then open any `.py` file in VS Code and run cells interactively.
